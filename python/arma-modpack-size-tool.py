...
if __name__ == "__main__":
    ...
    for mod in html_soup.find_all("tr"):
        ...
        modpack_df = pandas.concat(
            [
                modpack_df,
                pandas.DataFrame(data={"ID": [id], "Name": [mod_name], "Size": [0]}),
            ],
            ignore_index=True,
        )
    ...
    while not workshop_folder_found:
        ...
        if os.path.exists(workshop_folder_path) and os.path.dirname != "!WORKSHOP":
            ...
            print(
                "A typical true workshop folder path looks like steamapps\workshop\content\\107410"
            )
